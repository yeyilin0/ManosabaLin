...
public class HiroCardPool : TypeListCardPoolModel
{
	...
	// 指定大号能量图标的资源路径。
	public override string BigEnergyIconPath => "characters/Hiro/nikaido_hiro_energy.png".ImagePath();

	// 指定文本行内使用的小号能量图标资源路径。
	public override string TextEnergyIconPath => "characters/Hiro/nikaido_hiro_energy_small.png".ImagePath();
