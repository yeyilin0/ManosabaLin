...
public sealed class MalicesEncounter : ModEncounterTemplate
{
    public override IEnumerable<MonsterModel> AllPossibleMonsters => [ModelDb.Monster<MalicesMonster>()];
    ...
    [
        (ModelDb.Monster<MalicesMonster>().ToMutable(), null)
    ];
}
