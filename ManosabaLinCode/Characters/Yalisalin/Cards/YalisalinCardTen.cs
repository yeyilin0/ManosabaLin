...
public sealed class YalisalinCardTen : ManosabaCardTemplate
{
    public YalisalinCardTen() : base(2, CardType.Skill, CardRarity.Uncommon, TargetType.RandomEnemy)
    {
    }
