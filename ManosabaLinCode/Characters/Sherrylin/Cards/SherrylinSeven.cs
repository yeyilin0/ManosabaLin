...
public sealed class SherrylinSeven() : ManosabaCardTemplate(1, CardType.Skill, CardRarity.Uncommon, TargetType.AllAllies)
{
    ...
    {
        get { yield return HoverTipFactory.FromCard<SherrylinTwo>(IsUpgraded); }
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay, ComponentContext componentContext)
    {
        ...
        {
            var twoCard = source.CombatState.CreateCard<SherrylinTwo>(targetPlayer);
