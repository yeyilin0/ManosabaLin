...
public class Sherrylin : ManosabaCharacterTemplate<SherrylinCardPool, SherrylinRelicPool, SherrylinPotionPool>
{
    ...
    public override CharacterAssetProfile AssetProfile => new(
        ...
        new CharacterUiAssetSet(
            "sherrylin_map.png".CharacterImgPath(CharacterId),
            null,
            "sherrylin_icon.tscn".CharacterScenePath(CharacterId),
            "sherrylin_bg.tscn".CharacterScenePath(CharacterId),
            "sherrylin_char_select.png".CharacterImgPath(CharacterId),
            null,
            null,
            "sherrylin_map.png".CharacterImgPath(CharacterId)),
