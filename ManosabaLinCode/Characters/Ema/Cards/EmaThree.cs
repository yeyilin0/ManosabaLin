...
public sealed class EmaThree : ManosabaEmalinCardTemplate
{
    ...
    private const TargetType CardTarget = TargetType.AnyPlayer;

    private const int WithPowerReduction = 20;
    private const int CardsToDraw = 1;

    public EmaThree() : base(EnergyCost, Type, Rarity, CardTarget)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        {
            var reductionAmount = System.Math.Min(source.DynamicVars["Reduction"].IntValue, (int)targetWithPower.Amount);
