...
public class Emalin : ManosabaCharacterTemplate<EmalinCardPool, EmalinRelicPool, EmalinPotionPool>
{
    ...
    public override CharacterAssetProfile AssetProfile => new(
        ...
        new CharacterUiAssetSet(
            IconTexturePath: "emalin_map.png".CharacterImgPath(CharacterId),
            IconOutlineTexturePath: "emalin_map.png".CharacterImgPath(CharacterId),
            IconPath: "emalin_icon.tscn".CharacterScenePath(CharacterId),
            CharacterSelectBgPath: "emalin_bg.tscn".CharacterScenePath(CharacterId),
            CharacterSelectIconPath: "emalin_char_select.png".CharacterImgPath(CharacterId),
            MapMarkerPath: "emalin_map.png".CharacterImgPath(CharacterId)),
