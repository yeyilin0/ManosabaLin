...
public class EmalinCardPool : TypeListCardPoolModel, IModColorfulPhilosophersCardPool
{
    ...
    // 指定文本行内使用的小号能量图标资源路径。
    public override string TextEnergyIconPath => "characters/Emalin/emalin_energy_small.png".ImagePath();
